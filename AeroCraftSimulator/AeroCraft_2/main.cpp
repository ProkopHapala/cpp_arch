...
/*
	glFrustum ( -zoom*ASPECT_RATIO, zoom*ASPECT_RATIO, -zoom, zoom, 0.5, 10000);
	Quat4d qcam;
...
int makeBuildings( int nx, int ny, float sx, float sy, float cx, float cy,  float min_height, float max_height ){
