...
*/
	terrain   = FieldPatch::makeList( 3, { 0.5d,   {-tersz,-tersz,h0},  { tersz,-tersz,h0},  {-tersz,tersz,h0},   {tersz,tersz,h0}   }   );
	//terrain   = FieldPatch::makeList( 15, { 0.5,   Vec3d(-tersz,-tersz,h0),  Vec3d( tersz,-tersz,h0),  Vec3d(-tersz,tersz,h0),   Vec3d(tersz,tersz,h0)   }   );
