...
template <class TYPE, class VEC, class QUAT> 
class Quat4TYPE {
	public:
	union{
		struct{ TYPE x,y,z,w; };
...
class Quat4i : public Quat4TYPE< int,    Vec3i, Quat4i >{  };
class Quat4f : public Quat4TYPE< float,  Vec3f, Quat4f >{  };
class Quat4d : public Quat4TYPE< double, Vec3d, Quat4d >{  };
