...
float winx=1.00,winy=1.00; //depending on the perspective and windows aspect ratio
...
//float position[] = {   -200.0, -200.0, -200.0, 1.0};
float position[] = {   0.0, 0.0, +200.0, 1.0};
    ...
    //paint graph of total density
     ...
     glBegin(GL_LINES);
      for (int i=1;i<nsamples;i++){
       ...
       glVertex3f(x-winx,0.5*(DensTOT[i]/maxdens)-winy+0.15,0.0);
     }glEnd(); 
...
*/
    ...
    glTranslatef (0.0, 0.0, -zoom*8);    //move centre of rotation in molecule
 //   glTranslatef (0.0, 0.0, -depth);    //move centre of rotation in molecule
...
//  ======== FOG ========
/*
GLfloat fogColor[4]= {1.0f, 0.0f, 0.0f, 0.0f};		// Fog Color
