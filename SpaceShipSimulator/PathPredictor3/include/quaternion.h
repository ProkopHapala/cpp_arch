...
// =======  pitch, yaw, roll
	...
	inline void dpitch( TYPE angle ){ TYPE ca,sa; sincos_taylor2<TYPE>(angle,ca,sa); pitch( ca, sa );  };
	...
	inline void dyaw( TYPE angle ){ TYPE ca,sa; sincos_taylor2<TYPE>(angle,ca,sa); yaw( ca, sa );  };
	...
	inline void droll( TYPE angle ){ TYPE ca,sa; sincos_taylor2<TYPE>(angle,ca,sa); roll( ca, sa );  };
	...
	inline void dpitch2( TYPE angle ){ TYPE ca,sa; sincos_taylor2<TYPE>(angle,ca,sa); pitch2( ca, sa );  };
