...
class Vec2d{
    ...
    inline void mul( double f        ) { x*=f;   y*=f;   };
    inline void add( double f        ) { x+=f;   y+=f;   };
    inline void add( const Vec2d&  v ) { x+=v.x; y+=v.y; };
    inline void sub( const Vec2d&  v ) { x-=v.x; y-=v.y; };
    inline void mul( const Vec2d&  v ) { x*=v.x; y*=v.y; };
    inline void div( const Vec2d&  v ) { x/=v.x; y/=v.y; };

	inline void set_add( const Vec2d& a, double f       ){ x=a.x+f;      y=a.y+f;      };
	inline void set_mul( const Vec2d& a, double f       ){ x=a.x*f;      y=a.y*f;      };
	...
	inline void add_mul( const Vec2d& a, double f       ){ x+=a.x*f;     y+=a.y*f;     };
	inline void add_mul( const Vec2d& a, const Vec2d& b ){ x+=a.x*b.x;   y+=a.y*b.y;   };
	inline void add_div( const Vec2d& a, const Vec2d& b ){ x+=a.x/b.x;   y+=a.y/b.y;   };
	inline void sub_mul( const Vec2d& a, const Vec2d& b ){ x-=a.x*b.x;   y-=a.y*b.y;   };
	inline void sub_div( const Vec2d& a, const Vec2d& b ){ x-=a.x/b.x;   y-=a.y/b.y;   };

	inline void mul_add( const Vec2d& a, double f       ){ x*=(a.x+f  ); y*=(a.y+f  ); };
	inline void mul_add( const Vec2d& a, const Vec2d& b ){ x*=(a.x+b.x); y*=(a.y+b.y); };
	inline void mul_sub( const Vec2d& a, const Vec2d& b ){ x*=(a.x-b.x); y*=(a.y-b.y); };
	inline void div_add( const Vec2d& a, double f       ){ x/=(a.x+f  ); y/=(a.y+f  ); };
	inline void div_add( const Vec2d& a, const Vec2d& b ){ x/=(a.x+b.x); y/=(a.y+b.y); };
	inline void div_sub( const Vec2d& a, const Vec2d& b ){ x/=(a.x-b.x); y/=(a.y-b.y); };
